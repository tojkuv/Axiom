...
public struct ResourceIdentifier: Hashable, Comparable, Sendable {
    public let id: UUID
    public let type: DeadlockResourceType
    public let orderingKey: UInt64
    
    public init(id: UUID, type: DeadlockResourceType, orderingKey: UInt64) {
        self.id = id
        self.type = type
...
public enum DeadlockResourceType: String, Sendable {
    case actor
    case data
    case io
    case computation
...
public struct ResourceRequest {
    ...
    public let resources: [DeadlockResourceType: Int]
    
    public init(actor: ActorIdentifier, resources: [DeadlockResourceType: Int]) {
        self.actor = actor
        self.resources = resources
    }
}
...
public actor DeadlockPreventionCoordinator {
    ...
    public func requestResources(
        ...
        let _ = CFAbsoluteTimeGetCurrent() // startTime for potential timeout tracking
        ...
        do {
            return try await withDeadlockTimeout(timeout) { @Sendable in
...
public actor DeadlockDetector {
    private let strategies: [any DetectionStrategy] = [
...
protocol DeadlockRecoveryStrategy: Sendable {
...
public actor DeadlockRecovery {
    ...
    private var recoveryStrategies: [any DeadlockRecoveryStrategy] = []
...
struct VictimSelectionStrategy: DeadlockRecoveryStrategy, Sendable {
    func canRecover(_ cycle: DeadlockCycle) async -> Bool {
...
/// Deadlock transaction errors
public enum DeadlockTransactionError: Error {
    case notFound(UUID)
...
public actor TransactionLog {
    ...
    public func addOperation(to transactionID: UUID, operation: any Operation) async {
    ...
    public func rollback(transactionID: UUID, to checkpoint: CheckpointID? = nil) async throws {
        guard let transaction = transactions[transactionID] else {
            throw DeadlockTransactionError.notFound(transactionID)
        }
...
public actor BankersAlgorithm {
    private var available: [DeadlockResourceType: Int] = [:]
    private var maximum: [ActorIdentifier: [DeadlockResourceType: Int]] = [:]
    private var allocation: [ActorIdentifier: [DeadlockResourceType: Int]] = [:]
    
    public init() {}
    
    public func setAvailable(resources: [DeadlockResourceType: Int]) {
        available = resources
    }
    
    public func setMaximum(for actor: ActorIdentifier, resources: [DeadlockResourceType: Int]) {
        maximum[actor] = resources
    }
    
    public func setAllocation(for actor: ActorIdentifier, resources: [DeadlockResourceType: Int]) {
    ...
    private func checkSafeSequence(
        available: [DeadlockResourceType: Int],
        allocation: [ActorIdentifier: [DeadlockResourceType: Int]],
        maximum: [ActorIdentifier: [DeadlockResourceType: Int]]
    ) -> Bool {
        var work = available
    ...
    private func calculateNeed(
        maximum: [DeadlockResourceType: Int],
        allocation: [DeadlockResourceType: Int]
    ) -> [DeadlockResourceType: Int] {
        var need: [DeadlockResourceType: Int] = [:]
...
struct TransactionRollbackStrategy: DeadlockRecoveryStrategy, Sendable {
    func canRecover(_ cycle: DeadlockCycle) async -> Bool {
...
struct ResourcePreemptionStrategy: DeadlockRecoveryStrategy, Sendable {
    func canRecover(_ cycle: DeadlockCycle) async -> Bool {
...
/// Execute with timeout for deadlock prevention
