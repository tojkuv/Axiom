...
public extension Binding {
    ...
    func optional<T: Sendable>(defaultValue: T) -> Binding<T> where Value == T? {
        Binding<T>(
    ...
    func optional<T: Sendable>(
        defaultValue: T,
        isNil: @escaping @Sendable (T) -> Bool
...
public struct FormValidators {
    public static func required(_ value: String) -> FormValidationResult {
    ...
    public static func email(_ value: String) -> FormValidationResult {
        FormValidationResult(
    ...
    public static func phoneNumber(_ value: String) -> FormValidationResult {
        FormValidationResult(
    ...
    public static func minLength(_ length: Int) -> (String) -> FormValidationResult {
        return { value in
            FormValidationResult(
...
@propertyWrapper
public final class FormValue<Value>: ObservableObject, @unchecked Sendable {
