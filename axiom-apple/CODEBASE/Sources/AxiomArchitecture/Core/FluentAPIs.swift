...
public struct ClientConfiguration<State: AxiomState & Equatable, Action: Sendable>: Sendable {
...
public struct CommonChains {
    ...
    public static func validatedClient<State: AxiomState & Equatable, Action>(
        initialState: State,
