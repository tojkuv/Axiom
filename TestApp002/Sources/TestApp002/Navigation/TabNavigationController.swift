...
actor TabNavigationController {
    ...
    private var autoSavedState: NavigationState?
    ...
    func saveNavigationState() async throws -> NavigationState {
        guard let currentTab = currentTab else {
            throw TabNavigationError.noCurrentTab
        }
        ...
        return NavigationState(currentTab: currentTab, tabOrder: tabOrder, tabStates: tabStates)
    }
    
    func restoreNavigationState(_ state: NavigationState) async throws {
    ...
    private func getAutoSavedState() async -> NavigationState? {
