...
// Test routes for optional parameter scenarios from debug files
public sealed record TestRouteWithOptional(string? Id = null) : IRoute<TestRouteWithOptional>
{
    public static FrozenDictionary<string, object> Metadata { get; } = 
        FrozenDictionary<string, object>.Empty;
}

public sealed record FileRouteWithOptionalVersion(string Path, string? Version = null) : IRoute<FileRouteWithOptionalVersion>
{
    public static FrozenDictionary<string, object> Metadata { get; } = 
        FrozenDictionary<string, object>.Empty;
}
