...
public final class MemoryProfiler: ObservableObject {
    ...
    deinit {
        // Note: Cannot call stopMonitoring() due to MainActor isolation
    ...
    private func optimizeManagedCaches() -> MemoryCacheOptimizationResult {
        var actions: [String] = []
        var memoryFreed: UInt64 = 0
        ...
        return MemoryCacheOptimizationResult(actions: actions, memoryFreed: memoryFreed)
    }
...
public struct MemoryCacheOptimizationResult {
    public let actions: [String]
    public let memoryFreed: UInt64
}
...
public struct MemoryRecommendation {
    public let type: MemoryRecommendationType
    public let priority: RecommendationPriority
    public let description: String
    public let action: String
}

public enum MemoryRecommendationType: String {
...
public struct PotentialLeak {
    ...
    public init(id: String, detectedAt: Date, component: String, description: String, suspicionLevel: Double) {
        self.id = id
...
public struct MemoryGrowthPoint {
    public let timestamp: Date
    public let memoryUsage: UInt64
    public let component: String?
    public let growthRate: Double
    
    public init(timestamp: Date, memoryUsage: UInt64, component: String?, growthRate: Double) {
