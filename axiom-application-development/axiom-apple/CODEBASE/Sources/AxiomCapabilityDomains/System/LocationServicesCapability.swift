...
public actor LocationServicesCapability: DomainCapability {
    ...
    public func requestPermission() async throws {
        guard let manager = locationManager else {
            throw AxiomCapabilityError.unavailable("Location manager not initialized")
        }
    ...
    public func activate() async throws {
        ...
        guard CLLocationManager.locationServicesEnabled() else {
            throw AxiomCapabilityError.unavailable("Location services disabled")
        }
    ...
    public func startLocationUpdates() async throws {
        guard _state == .available else {
            throw AxiomCapabilityError.unavailable("Location services not available")
        }
