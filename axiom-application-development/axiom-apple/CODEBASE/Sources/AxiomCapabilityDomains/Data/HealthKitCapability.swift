...
public actor HealthKitCapability: DomainCapability {
    ...
    public func requestPermission() async throws {
        guard let store = healthStore else {
            throw AxiomCapabilityError.unavailable("HealthKit store not initialized")
        }
    ...
    public func activate() async throws {
        ...
        guard HKHealthStore.isHealthDataAvailable() else {
            throw AxiomCapabilityError.unavailable("HealthKit not available on this device")
        }
    ...
    public func querySamples(
        ...
        guard _state == .available else {
            throw AxiomCapabilityError.unavailable("HealthKit capability not available")
        }
