...
public struct NavigationOptions: Sendable {
    ...
    public init(animated: Bool = true, replace: Bool = false, clearHistory: Bool = false) {
    ...
    public static let immediate = NavigationOptions(animated: false)
    public static let replacing = NavigationOptions(replace: true)
}
...
public extension AxiomError {
    ...
    static func wrap(_ error: any Error, context: String) -> AxiomError {
